...
// Note: We use "import type" for LucideIcon to satisfy strict TypeScript rules
import { 
  Code2, 
  Layout, 
  Bug, 
...
const GlassCard: React.FC<GlassCardProps> = ({ children, className = "", hoverEffect = true }) => (
  <motion.div
    ...
    className={`bg-white/5 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-3xl relative overflow-hidden group ${className}`}
  >
    {/* Subtle sheen effect */}
    ...
    <div className="min-h-screen bg-[#030712] text-slate-200 font-sans selection:bg-blue-500/30 selection:text-blue-200 overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-6 px-4">
        ...
        >
          ...
          <a href="#contact" className="text-sm font-bold text-blue-400 hover:text-blue-300 ml-2">
            Let's Talk
          </a>
        </motion.div>
      </nav>
      ...
      <main className="relative z-10 container mx-auto px-6 md:px-12 lg:px-24 pb-24">
            ...
            >
              <div className="relative w-64 h-64 md:w-96 md:h-96">
                ...
                <div className="absolute inset-4 bg-[#030712] rounded-full z-10 flex items-center justify-center border border-white/10 overflow-hidden">
                   ...
                   <div className="w-full h-full bg-gradient-to-b from-slate-800 to-black opacity-80 flex items-end justify-center">
                      <div className="w-32 h-32 md:w-48 md:h-48 bg-slate-700 rounded-t-full blur-3xl opacity-50"></div>
                   </div>
                   <img 
                     src="/profile.jpg" 
                     alt="Profile" 
                     className="absolute inset-0 w-full h-full object-cover opacity-100" // Hidden fallback
                   />
                   {/* Glowing ring */}
                   <div className="absolute inset-0 border-2 border-blue-500/20 rounded-full"></div>
                   <div className="absolute inset-8 border border-violet-500/20 rounded-full"></div>
                </div>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 leading-relaxed">
                    ...
                    I enforce quality through rigorous <span className="text-red-300">QA Testing</span>.
                  </p>
                </div>
              </div>
            </GlassCard>
           ...
           <div className="relative pl-8 md:pl-0 md:max-w-3xl mx-auto space-y-12">
              ...
              >
                 ...
                 <p className="text-slate-400 text-sm leading-relaxed bg-white/5 p-4 rounded-xl border border-white/5 inline-block text-left">
                    Developing scalable web applications using React and Spring Boot. Collaborating with cross-functional teams to integrate APIs and optimize database queries.
                 </p>
              </motion.div>
              ...
              <motion.div 
                ...
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                className="relative md:w-1/2 md:ml-auto md:pl-12 ml-6 md:ml-0"
              >
                 <div className="absolute left-[-24px] md:left-0 md:-translate-x-1/2 top-1 w-4 h-4 bg-slate-600 rounded-full border-4 border-[#030712] z-10"></div>
                 <h3 className="text-xl font-bold text-white">QA Analyst (Project Based)</h3>
                 <div className="text-slate-500 text-sm font-medium mb-2">Freelance • 2023</div>
                 <p className="text-slate-400 text-sm leading-relaxed bg-white/5 p-4 rounded-xl border border-white/5 inline-block">
                    Executed manual and automated testing suites. Identified bugs in e-commerce platforms and improved system reliability by 20%.
                 </p>
              </motion.div>
              ...
              <motion.div 
                ...
                className="relative md:w-1/2 md:pr-12 ml-6 md:ml-0 md:text-right"
              >
                 <div className="absolute left-[-24px] md:left-full md:-translate-x-1/2 top-1 w-4 h-4 bg-slate-600 rounded-full border-4 border-[#030712] z-10"></div>
                 <h3 className="text-xl font-bold text-white">IT Student</h3>
                 <div className="text-slate-500 text-sm font-medium mb-2">Higher National Diploma • 2022</div>
                 <p className="text-slate-400 text-sm leading-relaxed">
                    Specialized in full-stack development and system analysis. Led the student developer community.
                 </p>
              </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <GlassCard className="group" hoverEffect={false}>
               ...
               <div className="h-48 bg-slate-800/50 rounded-xl mb-6 overflow-hidden relative">
                  ...
                  <div className="absolute bottom-2 right-2 px-2 py-1 bg-black/60 backdrop-blur-md rounded text-xs text-white border border-white/10">UI/UX Case Study</div>
               </div>
               <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-pink-400 transition-colors">FinTech Dashboard</h3>
               <p className="text-slate-400 text-sm mb-6 line-clamp-3">
                  A complete redesign of a banking interface focusing on accessibility and dark mode aesthetics. Created in Figma with interactive prototypes.
               </p>
               <div className="flex gap-2">
                  <span className="text-xs px-2 py-1 rounded bg-pink-500/10 text-pink-300 border border-pink-500/20">Figma</span>
                  <span className="text-xs px-2 py-1 rounded bg-white/5 text-slate-300 border border-white/10">Prototyping</span>
               </div>
            </GlassCard>
            ...
            <GlassCard className="group" hoverEffect={false}>
               ...
               <div className="h-48 bg-slate-800/50 rounded-xl mb-6 overflow-hidden relative">
                  ...
                  <div className="absolute bottom-2 right-2 px-2 py-1 bg-black/60 backdrop-blur-md rounded text-xs text-white border border-white/10">Web App</div>
               </div>
               <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-blue-400 transition-colors">E-Commerce Platform</h3>
               <p className="text-slate-400 text-sm mb-6 line-clamp-3">
                  Full-stack MERN application with Stripe payment integration, user authentication, and an admin panel for inventory management.
               </p>
               <div className="flex gap-2">
                  <span className="text-xs px-2 py-1 rounded bg-blue-500/10 text-blue-300 border border-blue-500/20">React</span>
                  <span className="text-xs px-2 py-1 rounded bg-green-500/10 text-green-300 border border-green-500/20">Node.js</span>
                  <span className="text-xs px-2 py-1 rounded bg-white/5 text-slate-300 border border-white/10">MongoDB</span>
               </div>
            </GlassCard>
            ...
            <GlassCard className="group" hoverEffect={false}>
               ...
               <div className="h-48 bg-slate-800/50 rounded-xl mb-6 overflow-hidden relative">
                  ...
                  <div className="absolute bottom-2 right-2 px-2 py-1 bg-black/60 backdrop-blur-md rounded text-xs text-white border border-white/10">QA Automation</div>
               </div>
               <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-red-400 transition-colors">AutoTest Suite</h3>
               <p className="text-slate-400 text-sm mb-6 line-clamp-3">
                  A comprehensive automated testing framework using Selenium and Jest to ensure 99.9% uptime for critical microservices.
               </p>
               <div className="flex gap-2">
                  <span className="text-xs px-2 py-1 rounded bg-red-500/10 text-red-300 border border-red-500/20">Selenium</span>
                  <span className="text-xs px-2 py-1 rounded bg-white/5 text-slate-300 border border-white/10">Jest</span>
               </div>
            </GlassCard>
             ...
             <div className="grid md:grid-cols-2 gap-12 relative z-10">
               <div>
                 ...
                 <div className="space-y-4">
                    ...
                    <a href="https://www.linkedin.com/in/mohamedsakith/" className="flex items-center gap-4 p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-colors border border-white/5">
               ...
               <form className="space-y-4" onSubmit={handleContactSubmit}>
                  <div>
                    ...
                    <input type="text" className="w-full bg-black/30 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-blue-500 transition-colors" placeholder="Your name" />
                  </div>
                  <div>
                    <label className="block text-xs font-bold uppercase text-slate-500 mb-2">Email</label>
                    <input type="email" className="w-full bg-black/30 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-blue-500 transition-colors" placeholder="your@email.com" />
                  </div>
                  <div>
                    <label className="block text-xs font-bold uppercase text-slate-500 mb-2">Message</label>
                    <textarea rows={4} className="w-full bg-black/30 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-blue-500 transition-colors" placeholder="Tell me about your project..."></textarea>
                  </div>
        ...
        <footer className="text-center text-slate-600 text-sm py-12 border-t border-white/5">
          <p>© {new Date().getFullYear()} Sakith Nizar.</p>
        </footer>
